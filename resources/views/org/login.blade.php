@extends('org.layout-auth')

@section('org_auth_content')
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-md-4 col-sm-4 col-xs-12" style="margin-top: 20px">
            <div class="text-center m-b-md custom-login">
                <h3>ORGANIZER LOGIN DASHBOARD</h3>
                <p>This is navodaya allumni organizer!</p>
            </div>
            <div class="hpanel">
                <div class="panel-body">
                    <form action="{{route('org.loginFormSubmit')}}" id="loginForm" method="post">
                        @csrf
                        ...
                        <a class="btn btn-default btn-block" href="{{route('org.orgRegForm')}}">Register</a>
                    </form>
                </div>
            </div>
        </div>
